{{
    config(
        ...
        location="../datalake/gold/graph/relationship/etablissement_located_in_commune_deleguee.csv",
        format="csv"
    )
}}
...
SELECT
    ...
    c.code_commune AS ":END_ID(CommuneDeleguee)"  -- noqa: RF04,RF05
